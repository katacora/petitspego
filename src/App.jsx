...
function App() {
  ...
  return (
    ...
    <div className="container mx-auto text-center p-4 overflow-x-hidden  ">
    <br/> <br/>
      ...
      {showPurchaseForm && (
        <div className="purchase-form bg-gray-800 text-white">
          ...
          <div className="purchase-actions">
            ...
            <button onClick={handleConfirmPurchase}className='bg-red-500/50 px-8 py-2 rounded-lg'>Cancelar compra</button>
            <br></br><br></br>
            <button onClick={handleConfirmPurchase} className='bg-green-500/50 px-8 py-2 rounded-lg'>Confirmar compra</button>
          </div>
        </div>
      )}
